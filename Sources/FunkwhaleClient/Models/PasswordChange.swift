...
@available(*, deprecated, renamed: "FunkwhaleClientAPI.PasswordChange")
public typealias PasswordChange = FunkwhaleClientAPI.PasswordChange

extension FunkwhaleClientAPI {

public struct PasswordChange: Codable, JSONEncodable, Hashable {

    static let oldPasswordRule = StringRule(minLength: nil, maxLength: 128, pattern: nil)
    static let newPassword1Rule = StringRule(minLength: nil, maxLength: 128, pattern: nil)
    static let newPassword2Rule = StringRule(minLength: nil, maxLength: 128, pattern: nil)
