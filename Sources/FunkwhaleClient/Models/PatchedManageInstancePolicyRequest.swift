//
// PatchedManageInstancePolicyRequest.swift
//
...
@available(*, deprecated, renamed: "FunkwhaleClientAPI.PatchedManageInstancePolicyRequest")
public typealias PatchedManageInstancePolicyRequest = FunkwhaleClientAPI.PatchedManageInstancePolicyRequest

extension FunkwhaleClientAPI {

public struct PatchedManageInstancePolicyRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(target: ManageTargetRequest? = nil, summary: String? = nil, isActive: Bool? = nil, blockAll: Bool? = nil, silenceActivity: Bool? = nil, silenceNotifications: Bool? = nil, rejectMedia: Bool? = nil) {
        self.target = target
