...
@available(*, deprecated, renamed: "FunkwhaleClientAPI.ManageActor")
public typealias ManageActor = FunkwhaleClientAPI.ManageActor

extension FunkwhaleClientAPI {

public struct ManageActor: Codable, JSONEncodable, Hashable {
