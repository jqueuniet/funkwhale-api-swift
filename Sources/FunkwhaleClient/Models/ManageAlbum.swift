...
@available(*, deprecated, renamed: "FunkwhaleClientAPI.ManageAlbum")
public typealias ManageAlbum = FunkwhaleClientAPI.ManageAlbum

extension FunkwhaleClientAPI {

public struct ManageAlbum: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int, fid: String? = nil, mbid: UUID? = nil, title: String, creationDate: Date? = nil, releaseDate: Date? = nil, cover: CoverField, domain: String, isLocal: Bool, tracksCount: Int, artist: ManageNestedArtist, attributedTo: ManageBaseActor, tags: [String]) {
        self.id = id
        self.fid = fid
        self.mbid = mbid
        self.title = title
