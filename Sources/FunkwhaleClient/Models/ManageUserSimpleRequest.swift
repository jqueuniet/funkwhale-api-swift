...
@available(*, deprecated, renamed: "FunkwhaleClientAPI.ManageUserSimpleRequest")
public typealias ManageUserSimpleRequest = FunkwhaleClientAPI.ManageUserSimpleRequest

extension FunkwhaleClientAPI {

public struct ManageUserSimpleRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(username: String, email: String? = nil, name: String? = nil, isActive: Bool? = nil, isStaff: Bool? = nil, isSuperuser: Bool? = nil, dateJoined: Date? = nil, lastActivity: Date? = nil, privacyLevel: PrivacyLevelEnum? = nil, uploadQuota: Int? = nil) {
