...
@available(*, deprecated, renamed: "FunkwhaleClientAPI.ManageBaseActorRequest")
public typealias ManageBaseActorRequest = FunkwhaleClientAPI.ManageBaseActorRequest

extension FunkwhaleClientAPI {

public struct ManageBaseActorRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(url: String? = nil, fid: String, preferredUsername: String?, domain: String, name: String? = nil, summary: String? = nil, type: FederationChoiceEnum? = nil, lastFetchDate: Date? = nil, inboxUrl: String? = nil, outboxUrl: String? = nil, sharedInboxUrl: String? = nil, manuallyApprovesFollowers: Bool? = nil) {
        self.url = url
        self.fid = fid
